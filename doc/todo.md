...
WBS-3 canary 與 bounded full-market 驗收已完成並歸檔。WBS-6 ChatGPT MCP contract／adapter 已完成；目前 connector 唯一剩餘驗收為 `WBS-8-CHATGPT-MCP-ACCEPTANCE`，完成後再依正式條件評估 `WBS-8-DEV-PILOT-ENTRY`。
